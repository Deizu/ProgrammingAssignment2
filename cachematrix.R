## This script includes 2 functions to use when performing matrix inversion.

## Function 1 - makeCacheMatrix
##
## The following function takes a MATRIX as input and outputs a LIST of 4 
## functions which allow us to set the value of the matrix, get the value of
## the matrix, set the value of the inverted matrix, and get the value of the
## inverted matrix.
